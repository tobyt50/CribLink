...
const ClientSidebar = ({
  ...
  const sidebarClasses = `
    transition-all duration-150 ease-in-out /* Faster transition duration */
  ...
  // Faster transition for the mobile sidebar animation and general motion
  const fastTransition = { duration: 0.15, ease: 'easeInOut' };
  ...
  return (
    <>
      <motion.div
        ...
        transition={fastTransition} /* Applied faster transition */
      >
