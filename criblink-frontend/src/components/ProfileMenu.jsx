    ...
    <div className="relative" ref={menuRef}>
      ...
      >
        {user ? (
          ...
          <User
            className={`w-7 h-7 ${darkMode ? "text-gray-200" : "text-gray-700"}`}
          />
        )}
        <motion.div
        ...
        >
          <ChevronDown
            className={`w-5 h-5 ${darkMode ? "text-gray-200" : "text-gray-700"}`}
          />
        </motion.div>
      </button>
        ...
        {showMenu && (
          ...
          >
            {user ? (
              <>
                <div
                  className={`px-4 py-2 text-xs uppercase tracking-wider border-b mb-1 ${darkMode ? "text-gray-400 border-gray-700" : "text-gray-500 border-gray-100"}`}
                >
                  {user.role}
                </div>
                ...
                <motion.button
                  ...
                  className={`w-full text-left flex items-center gap-3 px-4 py-2 text-sm font-medium transition-colors duration-200 ${darkMode ? "text-gray-200 hover:bg-gray-700" : "text-gray-700 hover:bg-yellow-50 hover:text-yellow-700"}`}
                >
