...
const PrivacySectionSkeleton = ({ darkMode }) => (
  <div className="space-y-8 animate-pulse">
      ...
      <div className="space-y-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="flex items-center space-x-3">
            <div
              className={`h-5 w-5 rounded-md ${darkMode ? "bg-gray-700" : "bg-gray-300"}`}
            ></div>
            <div
              className={`h-4 w-3/4 rounded ${darkMode ? "bg-gray-700" : "bg-gray-300"}`}
            ></div>
          </div>
        ))}
      </div>
    ...
    <div className={`pb-6 mb-6`}>
      ...
      ></div>
      <div
        className={`h-10 w-48 rounded-full ${darkMode ? "bg-gray-700" : "bg-gray-300"}`}
      ></div>
    </div>
...
function Privacy() {
    ...
    try {
      ...
      setPrivacyForm({
        ...
        communication_email_updates:
          userData.communication_email_updates ?? true,
        ...
        share_favourites_with_agents:
          userData.share_favourites_with_agents ?? false,
        share_property_preferences_with_agents:
          userData.share_property_preferences_with_agents ?? false,
      });
    } catch (error) {
      showMessage(
        error?.response?.data?.message || "Failed to load privacy settings.",
        "error",
      );
    } finally {
      setLoading(false);
  ...
  const handleDataExport = () => {
    showConfirm({
      ...
      message:
        "A link to download your data will be sent to your registered email address shortly.",
      onConfirm: () => {
        showMessage(
          "Your data export request has been initiated. Check your email.",
          "success",
        );
      },
    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <label
              htmlFor="share_favourites_with_agents"
              className={labelStyles}
            >
              Allow agents to view your favourited listings.
            </label>
          </div>
          <div className="flex items-center space-x-3">
            <input
            ...
            />
            <label
              htmlFor="share_property_preferences_with_agents"
              className={labelStyles}
            >
              Allow agents to view your property preferences.
            </label>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3">
            <input
              ...
              disabled
              className={`${checkboxStyles} cursor-not-allowed`}
            />
            <label
              htmlFor="cookie_essential"
              className={`${labelStyles} ${darkMode ? "text-gray-500" : "text-gray-600"}`}
            >
          ...
          <div className="flex items-center space-x-3">
            <input
              ...
              className={checkboxStyles}
            />
            <label htmlFor="cookie_analytics" className={labelStyles}>
              Analytics Cookies
            </label>
          </div>
          <div className="flex items-center space-x-3">
            <input
              ...
              className={checkboxStyles}
            />
            <label htmlFor="cookie_marketing" className={labelStyles}>
              Marketing Cookies
            </label>
          </div>
          <div className="flex items-center space-x-3">
            <input
              ...
              className={checkboxStyles}
            />
            <label htmlFor="cookie_functional" className={labelStyles}>
              Functional Cookies
            </label>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-3">
            <input
              ...
              className={checkboxStyles}
            />
            <label htmlFor="comm_updates" className={labelStyles}>
          ...
          <div className="flex items-center space-x-3">
            <input
              ...
              className={checkboxStyles}
            />
            <label htmlFor="comm_marketing" className={labelStyles}>
              Promotional Offers
            </label>
          </div>
          <div className="flex items-center space-x-3">
            <input
              ...
              className={checkboxStyles}
            />
            <label htmlFor="comm_newsletter" className={labelStyles}>
              Monthly Newsletter
            </label>
          </div>
        </div>
      ...
      <div className={`pb-6 mb-6`}>
        ...
        <button
          ...
          className="bg-cyan-600 text-white py-2 px-4 rounded-full hover:bg-cyan-700 font-semibold flex items-center"
        >
