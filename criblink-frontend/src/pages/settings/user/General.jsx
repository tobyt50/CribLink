    ...
    >
      ...
      >
        <div className="flex items-center justify-between flex-wrap gap-4 mb-5">
          <h3
            className={`text-lg md:text-xl font-bold flex items-center ${darkMode ? "text-gray-200" : "text-gray-800"}`}
          >
            <User className="mr-3 text-green-500" size={24} />Overview
          </h3>
            ...
            {isEditing ? (
              <>
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full font-medium text-sm ${darkMode ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-200 hover:bg-gray-300"}`}
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={updating}
                  className="px-4 py-1.5 font-medium rounded-full flex items-center text-sm bg-green-600 text-white disabled:opacity-50 hover:bg-green-700"
                >
                  {updating ? (
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-full font-medium flex items-center text-sm bg-green-600 text-white hover:bg-green-700"
              >
            ...
            <div className="flex flex-col items-center space-y-4 mt-2">
              ...
              {isEditing && (
                <input
                  ...
                  className={`block w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 ${darkMode ? "file:bg-green-600 file:text-white" : "file:bg-green-50 file:text-green-700"}`}
                />
              )}
            </div>
          </div>
