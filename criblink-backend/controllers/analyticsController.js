...
exports.getTotalUsersCount = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error fetching total users count" });
  }
};
...
exports.getRevenueSoldListings = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching revenue from sold listings",
      });
  }
};
...
exports.getTotalDealsClosed = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error fetching total deals closed" });
  }
};
...
exports.getListingStatusDistribution = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching listing status distribution",
      });
  }
};
...
exports.getListingsOverTime = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error fetching listings over time" });
  }
};
...
exports.getUserRegistrationTrends = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching user registration trends",
      });
  }
};
...
exports.getInquiryTrends = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error fetching inquiry trends" });
  }
};
...
exports.getPropertyTypeDistribution = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching property type distribution",
      });
  }
};
...
exports.getListingPriceDistribution = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching listing price distribution",
      });
  }
};
...
exports.getTopLocations = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error fetching top locations" });
  }
};
...
exports.getAgentPerformanceMetrics = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching agent performance metrics",
      });
  }
};
...
exports.getListingPurchaseCategoryDistribution = async (req, res) => {
  try {
    ...
    console.error(
      "Error fetching listing purchase category distribution:",
      err,
    );
    res
      .status(500)
      .json({
        error:
          "Internal server error fetching listing purchase category distribution",
      });
  }
};
...
exports.getListingBedroomsDistribution = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching listing bedrooms distribution",
      });
  }
};
...
exports.getListingBathroomsDistribution = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        error: "Internal server error fetching listing bathrooms distribution",
      });
  }
};
...
exports.getUserRoleDistribution = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error fetching user role distribution" });
  }
};
