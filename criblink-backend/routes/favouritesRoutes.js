...
router.delete('/properties/:property_id', favouritesController.removeFavouriteProperty);
...
router.get('/properties/status/:property_id', favouritesController.getFavouritePropertyStatus);
...
router.get('/agents/status/:agent_id', favouritesController.getFavouriteAgentStatus);
...
router.delete('/clients/:client_id', favouritesController.removeFavouriteClient);
...
router.get('/clients/status/:client_id', favouritesController.getFavouriteClientStatus);

// --- Agency Favourites ---
// Add an agency to favourites
router.post('/agencies', favouritesController.addFavouriteAgency);
// Remove an agency from favourites
router.delete('/agencies/:agency_id', favouritesController.removeFavouriteAgency);
...
router.get('/agencies/status/:agency_id', favouritesController.getFavouriteAgencyStatus);
