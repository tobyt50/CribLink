  ...
  <div className="space-y-8 animate-pulse">
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          className={`h-10 rounded-xl ${darkMode ? "bg-gray-700" : "bg-gray-300"}`}
        ></div>
        <div
          className={`h-10 rounded-xl ${darkMode ? "bg-gray-700" : "bg-gray-300"}`}
        ></div>
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label htmlFor="smtpHost" className={labelStyles}>
              SMTP Host
            </label>
            <input
              type="text"
      ...
      <div className={`pb-6 mb-6`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Switch
            ...
            isOn={notificationToggles.email}
            handleToggle={() => handleToggleChange("email")}
          />
          <Switch
            label="SMS Notifications"
            description="Get alerts on your phone."
            isOn={notificationToggles.sms}
            handleToggle={() => handleToggleChange("sms")}
          />
          <Switch
            label="In-App Notifications"
            description="See notifications in the dashboard."
            isOn={notificationToggles.inApp}
            handleToggle={() => handleToggleChange("inApp")}
          />
        </div>
      </div>
