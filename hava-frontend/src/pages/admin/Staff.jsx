    ...
    {viewMode === "graphical" ? (
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {[...Array(9)].map(
          (
            _,
            i, // 9 skeleton cards for graphical view
          ) => (
            <div
              key={i}
...
const Staff = () => {
  ...
  const handleExportCsv = async (scope) => {
    if (
      (scope === "current" && staffList.length === 0) ||
      (scope === "all" && totalStaff === 0)
    ) {
  ...
  const performStatusToggle = async (id, status) => {
    ...
    try {
      await axiosInstance.put(
        `${API_BASE_URL}/admin/staff/${id}/status`,
        { status: newStatus },
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      ...
      showMessage(
        `Staff member ${id} status changed to ${newStatus}.`,
        "success",
      );
      fetchStaff();
    } catch (error) {
  ...
  const performResetPassword = async (id) => {
    ...
    try {
      await axiosInstance.post(
        `${API_BASE_URL}/admin/staff/${id}/reset-password`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      ...
      showMessage(
        `Password reset link sent for staff member ${id}.`,
        "success",
      );
    } catch (error) {
  ...
  const handleActionApply = (staff, action) => {
    ...
    if (action === "suspend" || action === "activate")
      ...
      handleResetPassword(staff.employee_id);
        ...
        >
          ...
          {isMobile && (
            <div className="flex justify-between items-center mb-4">
              <div
                className={`flex items-center flex-grow rounded-xl shadow-sm border overflow-hidden mr-2 ${darkMode ? "bg-gray-700 border-gray-600" : "bg-white border-gray-300"}`}
              >
                <input
                  type="text"
                  placeholder="Search..."
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {staffList.map((staff) => (
                <StaffCard
                  ...
                  staff={staff}
                  onActionApply={(staff, action) =>
                    handleActionApply(staff, action)
                  }
              ...
              >
                <thead>
                  ...
                  >
                    ...
                    <th
                      className={`py-2 px-2 text-left whitespace-nowrap ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                      style={{ width: "150px" }}
                    >
                      Actions
                    </th>
                    ...
                    staffList.map((staff) => (
                      ...
                      >
                        <td
                          ...
                          title={
                            staff.employee_id && staff.employee_id.length > 10
                              ? staff.employee_id
                              : ""
                          }
                        >
                        ...
                        <td
                          ...
                          title={
                            staff.full_name && staff.full_name.length > 15
                              ? staff.full_name
                              : ""
                          }
                        >
                        ...
                        <td
                          className="py-2 px-2 max-w-[120px] truncate"
                          title={
                            staff.role && staff.role.length > 15
                              ? staff.role
                              : ""
                          }
                        >
                        ...
                        <td
                          className="py-2 px-2 max-w-[90px] truncate"
                          title={
                            staff.department && staff.department.length > 10
                              ? staff.department
                              : ""
                          }
                        >
                        ...
                        <td
                          ...
                          title={
                            staff.email && staff.email.length > 20
                              ? staff.email
                              : ""
                          }
                        >
                        ...
                        <td
                          className="py-2 px-2 max-w-[120px] truncate"
                          title={
                            staff.phone && staff.phone.length > 15
                              ? staff.phone
                              : ""
                          }
                        >
                        ...
                        <td
                          ...
                          title={
                            ...
                            formatDate(staff.start_date).length > 15
                              ? formatDate(staff.start_date)
                              : ""
                          }
                        >
                        ...
                        <td
                          ...
                          title={
                            staff.status && staff.status.length > 10
                              ? staff.status
                              : ""
                          }
                        >
