...
const AdminDashboard = () => {
  ...
  const goToAgents = () =>
    navigate("/admin/users", { state: { roleFilter: "agent" } });
  const goToClients = () =>
    navigate("/admin/users", { state: { roleFilter: "client" } });
  const goToListings = () => navigate("/admin/listings");
  const goToAvailableListings = () =>
    navigate("/admin/listings", { state: { statusFilter: "available" } });
    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        if (
          ...
          console.warn(
            "Authentication error during stats fetch (expected on logout).",
          );
          showMessage(
      ...
      try {
        ...
        const activityData = response.data.activities.map((a) => {
          ...
          if (type === "listing" || message.includes("listing")) {
            ...
            type === "agency_created" ||
            message.includes("agency created")
          ) {
        ...
        if (
          ...
          console.warn(
            "Authentication error during activity fetch (expected on logout).",
          );
        } else {
              ...
              <Card>
                ...
                >
                  <li className="truncate">
                    <strong>Top Performing Agencies:</strong> Identify agencies
                    with most listings, sales, or inquiries.
                  </li>
                  <li className="truncate">
                    <strong>Listing Performance:</strong> Track views,
                    inquiries, and conversion rates across the platform.
                  </li>
                  <li className="truncate">
                    <strong>User Engagement:</strong> Analyze active users,
                    login frequency, and feature usage.
                  </li>
                  <li className="truncate">
                    <strong>System Health:</strong> Monitor uptime, error rates,
                ...
                <div className="mt-4 text-center">
                  <button
                    onClick={() =>
                      showMessage("Detailed reports coming soon!", "info")
                    }
                    className={`text-sm hover:underline ${darkMode ? "text-green-400" : "text-green-600"}`}
                  >
